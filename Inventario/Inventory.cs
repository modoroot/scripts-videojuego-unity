...
public class Inventory : MonoBehaviour, ISaveManager {
    ...
    public bool CanCraft(ItemData_Equipment _itemToCraft, List<InventoryItem> _requiredMaterials) {
        ...
        Debug.Log("Item crafteado: " + _itemToCraft.name);
    ...
    public void UseFlask() {
        ItemData_Equipment currentFlask = GetEquipment(EquipmentType.Elixir);
        ...
        if (canUseFlask) {
            ...
            Debug.Log("perate elixir");
    }

    public bool CanUseArmor() {
        ItemData_Equipment currentArmor = GetEquipment(EquipmentType.Armadura);
